...
-  **Advanced Tips**: Advanced, niche tips are hidden from the default rotation until you opt in with **Show advanced tips** in settings. When shown, they carry a `◆` marker in the notification title
